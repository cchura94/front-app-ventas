        ...
        <v-dialog v-model="dialog" max-width="500px">
          ...
          <v-card>
            ...
            <v-card-actions>
              ...
              <v-btn color="blue darken-1" :disabled="estado_boton" text @click="guardar">
                Guardar
              </v-btn>
            </v-card-actions>
          </v-card>
        ...
        <v-dialog v-model="dialogDelete" max-width="500px">
          <v-card>
            <v-card-title class="text-h5"
              >¿Está seguro de eliminar el Proveedor?</v-card-title
            >
            <v-card-actions>
              <v-spacer></v-spacer>
...
<script>
import * as provServicio from "./../../../services/proveedorService";
export default {
  data() {
    return {
